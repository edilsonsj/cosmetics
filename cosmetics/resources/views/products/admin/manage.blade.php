...
<body>
    <table border="1">
        <tr bgcolor=#a6a6dd>
            ...
            <td>
                <font color="white"><b>Estoque</b></font>
            </td>
            <td>
        ...
        @foreach ($products as $product)
            <tr>
                <td>
                    <font color=#a6a6dd>{{ $product->id }}
                </td>
                </font>
                <td>
                    <font color=<div id="a6a6dd"><img src="/img/products/{{ $product->product_image_path }}"
                            style="width: 5vw"></div>
                </td>
                </font>
                <td>{{ $product->product_name }}</td>
                <td>
                    <font color=#a6a6dd><b>R$ {{ $product->product_price }}</b></font>
                </td>
                <td>
                    <font color=#a6a6dd>{{ $product->product_qty }}
                </td>
                </font>
                <td>
                    <font color=#a6a6dd>
